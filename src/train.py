...
from src.utils.local import get_datasets_root
os.environ["DATASETS_ROOT"] = get_datasets_root()
...
def train(cfg):
    ...
    for callback in callbacks:
        if isinstance(callback, RichProgressBar):
            callback.theme.metrics_format=".6f"
...
@hydra.main(version_base="1.3", config_path="../configs", config_name="train_imagen_mnist.yaml")
