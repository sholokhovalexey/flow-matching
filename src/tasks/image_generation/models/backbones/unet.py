...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        self.time_emb_cat = linear(2 * time_embed_dim, time_embed_dim)

        if self.num_classes is not None:
            # add extra "null" class for CFG
            self.label_emb = nn.Embedding(num_classes + 1, time_embed_dim) # num_classes + 1
